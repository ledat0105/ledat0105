...
public class SACH {
	...
	public void INSACH() {
		System.out.printf(
				"Ma sach: %4s |Ten Sach: %20s |Ten tac gia: %20s|Loai sach: %10s|Nha xuat ban: %10s|So trang: %2d|So tap: %2d|Gia:%4d|",
				this.ma, this.ten, this.tg, this.loai, this.nxb, this.trang, this.tap, this.gia);
